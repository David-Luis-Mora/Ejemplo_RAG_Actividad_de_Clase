...
async def main():
    ...
    agente = create_agent(
        model=ChatOllama(model="gemma4:e4b",base_url="http://192.168.117.48:11434", reasoning=True), # Usad alguno vuestro
        tools=tools,
        system_prompt= "Eres un asistente experto en League of Legends. "
        "Cuando el usuario mencione un campeón, automáticamente utiliza las herramientas "
        "del MCP de OP.GG para devolver builds óptimas, estadísticas y counters. "
        "No preguntes de nuevo por el juego. "
